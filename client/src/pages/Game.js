...
export const Game = () => {
    ...
    if (gameStarted) {
        return (_jsx("div", { className: "max-w-4xl mx-auto w-full px-4 py-8", children: _jsxs("div", { className: "p-8 bg-slate-950 border border-white/10 rounded-2xl shadow-2xl relative overflow-hidden text-center", children: [_jsx("div", { className: "absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-pool-cyan via-pool-purple to-pool-cyan shadow-[0_0_15px_#00f0ff]" }), _jsx("h2", { className: "text-3xl font-extrabold font-display text-white tracking-widest uppercase animate-pulse", children: "\uD83C\uDFB1 MATCH IN PROGRESS" }), _jsx("p", { className: "text-xs text-pool-cyan font-body mt-2", children: "Dynamic waiting room countdown finished. Game successfully initialized!" }), _jsxs("div", { className: "aspect-[2/1] max-w-2xl mx-auto my-8 bg-pool-felt border-4 border-amber-900 rounded-3xl relative flex flex-col items-center justify-center shadow-[inset_0_0_30px_rgba(0,0,0,0.6)]", children: [_jsx("div", { className: "absolute top-1 left-1 w-6 h-6 bg-neutral-900 rounded-full shadow-inner" }), _jsx("div", { className: "absolute top-1 right-1 w-6 h-6 bg-neutral-900 rounded-full shadow-inner" }), _jsx("div", { className: "absolute bottom-1 left-1 w-6 h-6 bg-neutral-900 rounded-full shadow-inner" }), _jsx("div", { className: "absolute bottom-1 right-1 w-6 h-6 bg-neutral-900 rounded-full shadow-inner" }), _jsx("div", { className: "absolute top-1 left-[50%] -translate-x-1/2 w-6 h-6 bg-neutral-900 rounded-full shadow-inner" }), _jsx("div", { className: "absolute bottom-1 left-[50%] -translate-x-1/2 w-6 h-6 bg-neutral-900 rounded-full shadow-inner" }), _jsxs("div", { className: "flex gap-4 items-center mb-2 z-10", children: [_jsx("span", { className: "text-white text-3xl animate-spin", children: "\u26AA" }), _jsx("span", { className: "text-white text-4xl", children: "\uD83C\uDFB1" })] }), _jsx("span", { className: "text-white/40 font-display font-extrabold text-sm tracking-wider uppercase select-none", children: "Pool Table Viewport (Gameplay coming soon!)" })] }), _jsxs("div", { className: "flex justify-center items-center gap-8 mb-8", children: [_jsxs("div", { className: "text-center", children: [_jsx("div", { className: "text-sm font-bold text-white font-display truncate max-w-[120px]", children: host?.username }), _jsx("div", { className: "text-[10px] font-bold text-pool-cyan uppercase tracking-wider mt-0.5", children: "Host" })] }), _jsx("div", { className: "text-slate-600 font-display text-2xl font-bold", children: "VS" }), _jsxs("div", { className: "text-center", children: [_jsx("div", { className: "text-sm font-bold text-white font-display truncate max-w-[120px]", children: guest?.username }), _jsx("div", { className: "text-[10px] font-bold text-pool-purple uppercase tracking-wider mt-0.5", children: "Opponent" })] })] }), _jsx("button", { onClick: handleLeaveRoom, className: "py-3 px-8 bg-rose-500/10 border border-rose-500/20 hover:bg-rose-500/20 text-rose-400 font-display font-bold text-xs rounded-xl shadow transition duration-300 transform active:scale-95", children: "Leave Match & Exit" })] }) }));
    }
